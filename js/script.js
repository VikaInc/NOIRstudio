...
function initializeGallery() {
    ...
    const savedCount = localStorage.getItem('visiblePhotosCount');
    if (savedCount) {
        visiblePhotos = parseInt(savedCount);
    }
    ...
    if (savedFilters) {
        ...
        filterCheckboxes.forEach(cb => {
            cb.checked = filtersArray.includes(cb.value);
        });
    }
...
function loadMorePhotos() {
    ...
    localStorage.setItem('visiblePhotosCount', visiblePhotos);
